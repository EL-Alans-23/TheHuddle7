"""Configuración del notifications-service.
...
class Settings:
    """Configuración tipada del servicio de notificaciones."""
    ...
    DATABASE_URL: str = _required("NOTIFICATIONS_DATABASE_URL")

    # Seguridad JWT compartida (valida tokens en peticiones entrantes)
